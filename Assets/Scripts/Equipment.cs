...
{   
    ...
    {
        // 1. Enlever le visuel de l'équipement sur le personnage + ré activer les parties visuelles qu'on avait désactivé pour cet objet
    ...
    {
        print("Item équipé : " + itemActionsSystem.itemCurrentlySelected.name);
